...
const CardGrid = () => {
  return (
    ...
    <Card webLink='https://rewritingthecode.org/' imgLink='https://mma.prnewswire.com/media/1800392/codepath_1x1_solid_dark_Logo.jpg?p=publish' imgDescription='CodePath Logo' description='CodePath'/>
